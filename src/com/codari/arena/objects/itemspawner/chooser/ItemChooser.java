...
public class ItemChooser {
	...
	public ItemStack generateItem(String link, ItemType itemType) {
		switch(itemType) {
		case POTION:
			return this.generatePotion(link);
		case WEAPON:
			return this.generateWeapon(link);
		case ARMOR:
			return this.generateArmor(link);
		}
		return null;
	}
